 ...
 * Updated to use full names as IPL-ALL now contains full player names
 */
export const commonNameMappings = {
  ...
  's malinga': ['lasith malinga'],
  'slinga malinga': ['lasith malinga'],

  'dwayne bravo': ['dwayne bravo'],
  'bravo': ['dwayne bravo'],
  'dj bravo': ['dwayne bravo'],
  'd bravo': ['dwayne bravo'],
 ...
 * This helps prioritize "Virat Kohli" over "T Kohli" when user searches "Kohli"
 */
