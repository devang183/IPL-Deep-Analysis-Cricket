  ...
  return (
    <div className="fixed top-20 md:top-24 right-16 md:right-20 z-50">
      ...
      {!isOpen ? (
        ...
        /* Expandable Panel */
        <div className="bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden animate-slide-in-right w-80 md:w-96">
          {/* Header */}
